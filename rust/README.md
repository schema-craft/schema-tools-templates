...
| custom_headers    |              | false               | When set to `true`, each endpoint method receives an additional `custom_headers: Option<HashMap<String, String>>` argument. These headers are applied last and override any previously set headers.  |
